...
component {
	...
	// Module Entry Point
	this.entryPoint         = "adobePDFRest";
	// Inherit Entry Point
	this.inheritEntryPoint  = false;
	// Model Namespace
	this.modelNamespace     = "adobePDFRest";
	// CF Mapping
	this.cfmapping          = "adobePDFRest";
	// Auto-map models
	...
	function configure(){
		...
		settings = {
			credentialPath   : getEnv( "PDF_API_CREDENTIAL_PATH", "" ),
			expireJWTHours   : getEnv( "PDF_API_EXPIRE_JWT_HOURS", 29 ),
			pollPauseTime    : 10000,
			credentialMethod : getEnv( "PDF_API_CREDENTIAL_METHOD", "JWT" ),
			scopes           : getEnv( "PDF_API_SCOPES", "openid,AdobeID,DCAPI" ),
			credentialMethod: "jwt"
		};
