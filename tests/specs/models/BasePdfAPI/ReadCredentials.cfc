        ...
        describe(
            ...
            body = function() {
                beforeEach(function() {
                    ...
                    preJSON2 = {
                        service_account_credentials: {'private_key_file': mockData($type = 'words:1', $num = 1)[1]}
                    };
                ...
                it('the first call to readFile should pass the credentialPath property', function() {
                    ...
                    expect(testObj._MOCKCALLLOGGERS.readFile[2][1]).tobe(
                        preJSON2.service_account_credentials.private_key_file
                    );
                });
            }
        );
